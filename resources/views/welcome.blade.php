    ...
    <header>
        ...
        <nav>
            <ul class="nav-links">
                ...
                @if (auth() -> check())
                <a href="{{url('dia-amor')}}"><li>Fundacion Guadalajara</li></a>
    ...
    <main>
        ...
        <div class="cuadricula">
            ...
            <section class="items item2">
                <p>En Jalisco siempre destacan dos fechas muy importantes, el 14 de Febrero y el 8 de Marzo (el dia de la fundacion de Guadalajara y el dia de la mujer respectivamente).</p>
                <br>
